...
import logo from '../../assets/Crops Armor.png';
        ...
        <div className="navbar bg-base-100">
                    <div className="navbar-start">
                        ...
                        <Link to="/">
                            <div className="flex items-center">
                                ...
                                <h2 className="text-3xl font-bold text-green-800">CROPS <span className="text-green-600">ARMOR</span></h2>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="navbar-end">
                        ...
                        <label tabIndex={0} className="btn btn-ghost btn-circle avatar tooltip tooltip-bottom" data-tip={user.displayName}>
                            ...
                            user ?
                                <button onClick={handleSignOut} className="btn bg-red-500 ml-2 text-white">Logout</button>
                            :
                            <Link to="/login">
                            <button className="btn bg-green-500 ml-2 text-white">Login</button>
                            </Link>
                        }
                    </div>
                </div>
