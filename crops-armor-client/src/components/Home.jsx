                    ...
                    <>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
                                ...
                                <p className="text-3xl lg:text-4xl">{firstData.temperature}°C</p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
                                ...
                                <p className="text-3xl lg:text-4xl">{firstData.soundFrequency}Hz</p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
                                <h2 className="text-xl lg:text-2xl font-semibold mb-2">Animal Presence</h2>
                                <p className="text-3xl lg:text-4xl">{firstData.animalPresence ? "Yes" : "No"}</p>
                            </div>
                        </div>
                    </>
                )}
                                ...
                                <tbody>
                                    {currentRows.map((data, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="border px-4 py-2">{data.animalPresence ? "Yes" : "No"}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
