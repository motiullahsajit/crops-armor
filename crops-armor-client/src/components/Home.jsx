    ...
    <div className="flex flex-col mb-10 md:flex-row bg-gray-100 rounded-2xl">
      ...
      <div className="flex-1 p-5 md:p-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 bg-gray-50">
          ...
          <div className="justify-center items-center bg-white p-6 rounded-lg shadow-md">
            <img
              src="https://ipad.fas.usda.gov/countrysummary/images/BG/cropcalendar/bg_bg_1_calendar.png"
              alt="Crop Calendar"
