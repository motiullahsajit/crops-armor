                    ...
                    <div className="w-full text-center justify-center shadow-2xl">
                        <form onSubmit={handleLogin} className="card-body justify-center mt-10">
                            ...
                            <div className="relative form-control">
                                <input className="input input-bordered" placeholder="Password" type={showPassword ? "text" : "password"} name="password" />
                                <span className="absolute top-3 right-3" onClick={() => setShowPassword(!showPassword)}>
                                    {showPassword ? <IoEyeOff /> : <IoEye />}
                                </span><br />
                            </div>
                            <div className="form-control space-y-5 mt-6">
                                <button className="btn border-green-400 bg-white text-green-600">Login</button>
                            </div>
                        </form>
                        <div className="form-control px-8 pb-7">
                        <button onClick={handleDemoLogin} className="btn btn-success">Demo User</button>
                        </div>
                    </div>
                </div>
            </div>
